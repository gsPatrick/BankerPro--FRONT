...
export function isOnboardingCompleted(userOrProfile) {
  ...
  if (userOrProfile.onboardingCompleted === true || userOrProfile.onboarding_completed === true) return true;
  if (userOrProfile.profile?.onboardingCompleted === true || userOrProfile.profile?.onboarding_completed === true) return true;
