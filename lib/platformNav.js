...
function IconWhatsapp() {
  return (
    <svg {...iconProps}>
      <path d="M21 11.5a8.38 8.38 0 0 1-8.5 8.5 8.5 8.5 0 0 1-4-1L3 20l1-5.5a8.5 8.5 0 0 1-1-4 8.38 8.38 0 0 1 8.5-8.5A8.5 8.5 0 0 1 21 11.5z" />
      <path d="M8.5 8.8c0 3 2.2 5.2 5.2 5.2l1-1.4-1.6-.7-.7.8a3.4 3.4 0 0 1-1.6-1.6l.8-.7-.7-1.6-1.4 1z" />
    </svg>
  );
}
