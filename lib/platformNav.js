...
// Robô-mascote do Copiloto: cabeça, antenas, olhos, orelhas e rabinho de balão.
// Traço em currentColor — funciona no botão central claro (mobile) e na sidebar escura.
function IconCopilot() {
  return (
    <svg {...iconProps}>
      {/* antenas */}
      <path d="M9 6.8 8.5 4.2" />
      <path d="M15 6.8 15.5 4.2" />
      <circle cx="8.4" cy="3.7" r="0.6" fill="currentColor" stroke="none" />
      <circle cx="15.6" cy="3.7" r="0.6" fill="currentColor" stroke="none" />
      {/* orelhas */}
      <path d="M4.4 11 4.4 14" />
      <path d="M19.6 11 19.6 14" />
      {/* cabeça */}
      <rect x="5" y="7" width="14" height="10" rx="4" />
      {/* rabinho do balão (canto inferior esquerdo) */}
      <path d="M9 17 6.2 20 11 17" />
      {/* olhos */}
      <circle cx="9.7" cy="11.7" r="1.6" strokeWidth="1.6" />
      <circle cx="14.3" cy="11.7" r="1.6" strokeWidth="1.6" />
      {/* boca com nó */}
      <path d="M12.2 15.2 15 15.2" />
      <circle cx="11.5" cy="15.2" r="0.55" fill="currentColor" stroke="none" />
    </svg>
  );
}
...
export const PLATFORM_NAV_ITEMS = [
  ...
  { id: 'copiloto', href: '/copiloto', label: 'Copiloto IA', icon: <IconCopilot />, group: 'ia' },
  {
    id: 'analise_audio',
    href: '/analise-audio',
